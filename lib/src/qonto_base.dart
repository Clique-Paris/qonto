...
class Qonto {
  ...
  Future<List<Membership>> get members async {
    ...
    do {
      response = (await authorizedRequest('memberships?current_page=${current_page}', id, secret));
  ...
  Future<List<Label>> get labels async {
    ...
    var result = <Label>[];
    do {
      response =  (await authorizedRequest('labels?current_page=${current_page}', id, secret));
  ...
  Future<Organization> get organization async {
    var response = (await authorizedRequest('organizations/${id}', id, secret))['organization'];
  ...
  Future<List<Transaction>> transactions(
    ...
    do {
      var endpoint = 'transactions?slug=${slug}&iban=${iban}&current_page=${current_page}';
      if (status != null) {
    ...
    Future<Attachment> attachment(String attachmentId) async {
      var response = (await authorizedRequest('attachments/${attachmentId}', id, secret));
